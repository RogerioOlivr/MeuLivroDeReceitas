...
{
    var deleteUserServiceBusConnection = builder.Configuration.GetValue<string>("Settings:ServiceBus:DeleteUserAccount");

    if (!string.IsNullOrWhiteSpace(deleteUserServiceBusConnection))
    {
